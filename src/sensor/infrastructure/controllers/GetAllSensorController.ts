    ...
    try {
      ...
      if (sensores) {
        ...
        const mediaTemperatura =
          totalSensores > 0 ? sumaTemperatura / totalSensores : null;
        const mediaHumedad =
          totalSensores > 0 ? sumaHumedad / totalSensores : null;
        const mediaLuz = totalSensores > 0 ? sumaLuz / totalSensores : 0;

        const porcentajeTemperaturaMayor24 =
          (contadorTemperaturaMayor24 / totalSensores) * 100;
        const porcentajeHumedadMayor60 =
          (contadorHumedadMayor60 / totalSensores) * 100;
